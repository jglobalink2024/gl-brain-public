---
name: COMMAND Sales Pipeline — Active Prospects + Entity Register
description: Active T1 prospects with status and next actions; Blaz context; pipeline CRM substitute. Source: entities.md (260413).
type: project
---
...
- **Company:** Prime Momentum (consulting firm)
- **Status:** P3 WARM — responded positively to T1 outreach
- **Role in pipeline:** Active prospect AND referral source for Richard and Grant Carlson
- **Demo:** Product demo occurred 2026-04-06 — this is who "Blaz demo" references in build state
- **Note from playbook:** "Grant — Blaz connected us" — Blaz is the warm bridge into the Grant Carlson relationship
- **Touch sequence:** COMMAND_LinkedIn_DM_Sequence_v2.md tracks his sequence

## Grant Carlson — detail

- **Company:** Global Entry Hub (side venture); also ops leader at SBM
- **Profile:** West Point background, systems thinker — Double-Pain Operator archetype (Classic A persona)
- **Potential:** Multi-seat (8 people in team)
- **Post-call one-pager:** Sent
- **HARD RULE:** Do not raise follow-up until 7-day window from call date has passed

## Eric — detail

- **Role:** P1 Beta user — first beta user, treating as canary for pilot experience
- **Gate:** Phase 2.5 complete (met as of 260413)
